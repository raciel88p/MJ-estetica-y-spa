...
export default function PaquetesContent() {
  ...
  return (
    <div className="min-h-screen bg-stone-50">
      <SEO
        title="Paquetes y Promociones - MJ Fisio Estética y Spa"
        description="Descubre nuestras promociones y paquetes exclusivos en Turrialba."
        canonical="/paquetes"
      />
      <Navbar />
      ...
      <main className="pt-32 pb-20 max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-16">
          <div className="flex justify-center items-center gap-3 mb-4">
             <h1 className="text-4xl sm:text-6xl font-serif font-bold text-stone-900">Nuestros Paquetes</h1>
             <button
                onClick={toggleAdmin}
          ...
          <p className="text-stone-500 max-w-2xl mx-auto text-lg">Aprovecha nuestras ofertas especiales diseñadas para tu bienestar.</p>
        </div>
            ...
            >
              ...
              >
                <div className="flex flex-col items-center text-center mb-6">
                  ...
                  <h3 className="text-2xl font-serif font-bold text-stone-900">Acceso Administrador</h3>
                  <p className="text-stone-500 text-sm mt-2">Ingresa tu clave para gestionar las promociones.</p>
                </div>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-sm border border-primary/10 relative overflow-hidden">
               <div className="absolute top-0 right-0 p-4">
                  <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-primary/10 text-primary text-xs font-bold uppercase tracking-wider">
                    <Unlock className="w-3 h-3" /> Modo Edición Activo
                  </span>
               </div>

               <h2 className="text-xl font-serif font-bold text-stone-800 mb-6">Subir nuevas promociones</h2>
        ...
        {isLoading ? (
          <div className="text-center py-20">
            ...
            <p className="text-stone-400 font-serif italic text-lg">Cargando paquetes...</p>
          </div>
        ) : images.length > 0 ? (
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-6">
                    <div className="text-white">
                        <p className="text-xs font-bold uppercase tracking-[0.2em] mb-1 opacity-80">Promoción</p>
          ...
          <div className="text-center py-32 bg-white rounded-[2.5rem] shadow-sm border border-stone-100">
            ...
            <h3 className="text-2xl font-serif text-stone-400 italic">No hay promociones activas</h3>
            <p className="text-stone-300 mt-2">Vuelve pronto para ver nuestras novedades.</p>
          </div>
        )}
      </main>
