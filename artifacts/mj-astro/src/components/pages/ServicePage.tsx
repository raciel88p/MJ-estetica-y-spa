...
function ServicePage({ service }: { service: ServicePageData }) {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {(service.slug === "limpieza-facial" || service.slug === "terapias-faciales") && (
