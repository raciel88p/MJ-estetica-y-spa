...
function ServicePage({ service }: { service: ServicePageData }) {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {!["botox-full-face","hilos-tensores","rellenos-labios","acido-hialuronico","trasplante-capilar","implante-barba","mesoterapia-capilar","biorevitalizacion", "masajes-corporales"].includes(service.slug) && (
