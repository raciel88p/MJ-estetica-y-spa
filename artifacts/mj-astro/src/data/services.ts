...
export const servicePages: ServicePageData[] = [
...

  {
    ...
    heroDescription: `✨ EL SECRETO COREANO QUE ESTÁ REVOLUCIONANDO EL REJUVENECIMIENTO FACIAL YA LLEGÓ A COSTA RICA ✨

¿Te imaginas despertar con una piel más luminosa, hidratada y rejuvenecida… sin cirugías ni cambios artificiales?

Eso es exactamente lo que muchas personas están logrando gracias al tratamiento de ADN de Salmón (Polynucleotides), una de las terapias más innovadoras en medicina estética avanzada.
