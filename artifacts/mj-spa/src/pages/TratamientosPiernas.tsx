  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        ...
        description="Tratamientos de piernas en MJ Estética Wellness Center: varices, arañas vasculares, piernas cansadas, anticelulitis y más en Turrialba, Costa Rica."
      ...
      <section className="relative pt-36 pb-24 bg-[#071e2e] overflow-hidden">
        <div
          ...
          style={{ backgroundImage: `url(${import.meta.env.BASE_URL}images/spa-texture.webp)` }}
        />
