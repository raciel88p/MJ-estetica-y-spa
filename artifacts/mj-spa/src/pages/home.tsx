      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-stone-400 text-sm mb-12 leading-relaxed max-w-md mx-auto">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
          ...
          >
            <div>
              ...
              <h2 className="text-4xl md:text-5xl font-serif font-bold text-stone-900 leading-tight">
                Lo que dicen<br />
                <span className="font-light italic text-stone-400">nuestras clientas</span>
              </h2>
            </div>
            <Link href="/testimonios">
              <span className="text-xs font-bold text-stone-400 hover:text-primary transition-colors cursor-pointer tracking-[0.2em] uppercase whitespace-nowrap">
                Ver todos →
              </span>
            </Link>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
            ...
            >
              ...
              <div className="flex flex-col gap-4 mb-12">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-stone-400 text-xs mt-0.5">Respuesta inmediata</p>
                  </div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-stone-400 text-xs mt-0.5">+506 86907757</p>
                  </div>
                  <ArrowRight className="w-4 h-4 text-stone-300 group-hover:text-primary ml-auto group-hover:translate-x-1 transition-all" />
                </a>
              </div>
              ...
              <div className="border-t border-stone-100 pt-8">
                <p className="text-[10px] font-bold text-stone-400 tracking-[0.3em] uppercase mb-5">SÍGUENOS</p>
                <div className="flex gap-3">
                  {[
                    ...
                    <a key={s.label} href={s.href} target="_blank" rel="noopener noreferrer"
                      className="w-10 h-10 border border-stone-200 flex items-center justify-center text-xs font-bold text-stone-400 hover:border-primary hover:text-primary transition-all">
                      {s.label}
                    </a>
                  ))}
                </div>
            ...
            >
              ...
              <p className="text-stone-400 text-sm mb-8">Te contactaremos a la brevedad posible.</p>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                <div>
                  <label className="block text-[10px] font-bold text-stone-500 uppercase tracking-[0.25em] mb-2">Nombre completo</label>
                  <Input
                    {...form.register("name")}
                ...
                <div className="grid grid-cols-2 gap-5">
                  <div>
                    <label className="block text-[10px] font-bold text-stone-500 uppercase tracking-[0.25em] mb-2">Email</label>
                    <Input
                      {...form.register("email")}
                  ...
                  <div>
                    <label className="block text-[10px] font-bold text-stone-500 uppercase tracking-[0.25em] mb-2">Teléfono</label>
                    <Input
                      {...form.register("phone")}
                      placeholder="+506..."
                      className="rounded-none border-0 border-b border-stone-200 bg-transparent px-0 py-3 focus-visible:ring-0 focus-visible:border-primary placeholder:text-stone-300 text-sm"
                ...
                <div>
                  <label className="block text-[10px] font-bold text-stone-500 uppercase tracking-[0.25em] mb-2">Servicio de interés</label>
                  <select
                ...
                <div>
                  <label className="block text-[10px] font-bold text-stone-500 uppercase tracking-[0.25em] mb-2">Mensaje</label>
                  <Textarea
