...
export default function ServicePage({ service }: { service: ServicePageData }) {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {(service.slug === "terapias-faciales" || service.slug === "limpieza-facial-turrialba") && (
