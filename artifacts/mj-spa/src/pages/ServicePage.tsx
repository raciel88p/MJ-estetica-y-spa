    ...
    <div className="min-h-screen bg-white">
      ...
      {(() => {
        const doctorMap: Record<string, { name: string; code: string; specialty: string; photo?: string; bio: string }> = {
          "nutricion":           { name: "Dr. Johan",                  code: "0070",   specialty: "Nutricionista Deportivo",  photo: "dr-johan.png",               bio: "Especialista en nutrición clínica y deportiva. Diseña planes alimentarios personalizados orientados a objetivos de salud, rendimiento y composición corporal." },
