    ...
    <div className="min-h-screen bg-white">
      ...
      {(() => {
        const doctorMap: Record<string, { name: string; code: string; specialty: string; photo: string; bio: string }> = {
          ...
          "botox-full-face":     { name: "Dr. Ricard Araya",           code: "323106", specialty: "Especialista en armonización facial",  photo: "dr-ricard-araya.jpg",   bio: "Médico especialista en medicina estética y tratamientos faciales mínimamente invasivos. Experto en toxina botulínica, ácido hialurónico e hilos tensores con enfoque en resultados naturales." },
