...
export default function ServicePage({ service }: { service: ServicePageData }) {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {!["botox-full-face","hilos-tensores","rellenos-labios","acido-hialuronico","trasplante-capilar","implante-barba","mesoterapia-capilar","nutricion","biorevitalizacion"].includes(service.slug) && (
      ...
      <section className="py-16 bg-white border-t border-stone-100">
        <div className="max-w-4xl mx-auto px-6 sm:px-10">
          ...
          {!["nutricion", "botox-full-face", "hilos-tensores", "rellenos-labios", "acido-hialuronico", "trasplante-capilar", "implante-barba", "mesoterapia-capilar", "biorevitalizacion", "depilacion-laser", "masajes-corporales"].includes(service.slug) && (
            <>
